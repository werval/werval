...
# core
$FIGLET org.qiweb
./org.qiweb/gradlew -b org.qiweb/build.gradle check install
echo "Checked."

# modules
$FIGLET org.qiweb.modules
./org.qiweb.modules/gradlew -b org.qiweb.modules/build.gradle check install
echo "Checked."

# gradle plugin
$FIGLET org.qiweb.gradle
./org.qiweb.gradle/gradlew -b org.qiweb.gradle/build.gradle install check
echo "Checked."
