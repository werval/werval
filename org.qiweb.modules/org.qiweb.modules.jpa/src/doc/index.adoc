...
In order to use the `JPAPlugin` you must add a dependency to `org.qiweb.modules.jpa` and register the plugin in your
configuration.
...
----
compile 'org.qiweb:org.qiweb.modules.jpa:{qiweb-version}'
----
...
<dependency>
    ...
    <artifactId>org.qiweb.modules.jpa</artifactId>
...
app.plugins = [
    ...
    { plugin = org.qiweb.modules.jdbc.JDBCPlugin },
    { plugin = "org.qiweb.modules.jpa.JPAPlugin" }
]
----
...
[source,java]
----
include::src/test/java/org/qiweb/modules/jpa/DocumentationSupport.java[lines=18..22,indent=0]

include::src/test/java/org/qiweb/modules/jpa/DocumentationSupport.java[lines=26..35,indent=0]
----
...
[source,java]
----
include::src/test/java/org/qiweb/modules/jpa/DocumentationSupport.java[lines=39..47,indent=0]
----
...
include::src/test/java/org/qiweb/modules/jpa/DocumentationSupport.java[lines=50..59,indent=0]
----
...
[source,java]
----
include::src/test/java/org/qiweb/modules/jpa/DocumentationSupport.java[lines=63..71,indent=0]
----
...
[source,java]
----
include::src/test/java/org/qiweb/modules/jpa/Controller.java[lines=19..20,indent=0]
import org.qiweb.modules.jpa.JPA;

include::src/test/java/org/qiweb/modules/jpa/Controller.java[lines=23..24,indent=0]

public class AnyController
{
include::src/test/java/org/qiweb/modules/jpa/Controller.java[lines=31..47,indent=4]
}
----
...
public class AnyController
{
include::src/test/java/org/qiweb/modules/jpa/Controller.java[lines=49..67,indent=4]
}
----
...
public class AnyController
{
include::src/test/java/org/qiweb/modules/jpa/Controller.java[lines=69..76,indent=4]
}
----
