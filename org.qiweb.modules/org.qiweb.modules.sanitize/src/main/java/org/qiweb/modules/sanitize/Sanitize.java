...
public final class Sanitize
{
    ...
    public String html( String input )
    {
        ...
        if( metrics != null )
        {
            timer = metrics.metrics().timer( "org.qiweb.modules.sanitize.html" ).time();
        }
        try
        {
            if( isEmpty( input ) )
    ...
    public String css( String input )
    {
        ...
        if( metrics != null )
        {
            timer = metrics.metrics().timer( "org.qiweb.modules.sanitize.css" ).time();
        }
        try
        {
            if( isEmpty( input ) )
    ...
    public String json( String input )
    {
        ...
        if( metrics != null )
        {
            timer = metrics.metrics().timer( "org.qiweb.modules.sanitize.json" ).time();
        }
        try
        {
            if( isEmpty( input ) )
