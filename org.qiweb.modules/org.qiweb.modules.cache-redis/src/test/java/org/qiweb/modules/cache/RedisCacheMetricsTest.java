...
public class RedisCacheMetricsTest
{
        ...
        throws Exception
    {
        expect()
            ...
            .body( "meters.'org.qiweb.modules.cache.redis.qiweb-cache.hits'.count", is( 2 ) )
            .body( "meters.'org.qiweb.modules.cache.redis.qiweb-cache.misses'.count", is( 4 ) )
            .body( "timers.'org.qiweb.modules.cache.redis.qiweb-cache.gets'.count", is( 6 ) )
            .body( "timers.'org.qiweb.modules.cache.redis.qiweb-cache.sets'.count", is( 2 ) )
            .body( "timers.'org.qiweb.modules.cache.redis.qiweb-cache.removes'.count", is( 1 ) )
            .when()
            .get( "/" );
    }
}
