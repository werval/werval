...
public class RemoveSetHeadersTest
{
    ...
    public static final QiWebHttpRule QIWEB = new QiWebHttpRule( new RoutesParserProvider(
        "GET /setHeader org.qiweb.filters.RemoveSetHeadersTest$Controller.setHeader\n"
        + "GET /removeHeaders org.qiweb.filters.RemoveSetHeadersTest$Controller.removeHeaders\n"
    ) );
