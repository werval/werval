...
public class NewDevShell
{
    ...
    public void start()
    {
        ...
        try
        {
            ...
            warn( "NewDevShell Class ClassLoader is: " + getClass().getClassLoader() );
            ...
            appRealm.loadClass( "com.acme.app.FakeController" );
            appRealm.loadClass( "com.acme.app.FakeControllerInstance" );
