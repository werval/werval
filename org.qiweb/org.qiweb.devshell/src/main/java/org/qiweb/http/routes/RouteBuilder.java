...
public final class RouteBuilder
{
    ...
    public static abstract class MethodRecorder<T>
    {
        ...
        private final List<Couple<String, Class<?>>> controllerParams = new ArrayList<Couple<String, Class<?>>>();
    ...
    public static Routes parseRoutes( String routesString )
    {
        ...
        while( scanner.hasNextLine() )
        {
            ...
            {
                routes.add( parseRoute( routeString ) );
            }
        }
        return routes;
    }
        ...
        throws IllegalRouteException
    {
        ...
        try
        {
            ...
            Class<?> controllerType = Class.forName( controllerTypeName );

            // Parse controller method parameters
            List<Couple<String, Class<?>>> controllerParams = new ArrayList<Couple<String, Class<?>>>();
    ...
    {
        final ObjectHolder<String> methodNameHolder = new ObjectHolder<String>();
