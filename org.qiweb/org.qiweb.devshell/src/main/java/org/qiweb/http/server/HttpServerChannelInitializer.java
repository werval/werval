    ...
    extends ChannelInitializer<Channel>
{
    ...
    /* package */ HttpServerChannelInitializer( ChannelGroup allChannels, HttpApplication httpApp )
    {
        ...
        throws Exception
    {
        ...
        pipeline.addLast( "subprotocol-switcher", new SubProtocolSwitchHandler( allChannels, httpApp ) );
    }
}
