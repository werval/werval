...
import org.qiweb.http.routes.RoutesParserProvider;
...
public class RouterTest
{
        ...
        throws Exception
    {
        ...
        HttpServerConfig config = new HttpServerConfig( LISTEN_ADDRESS, LISTEN_PORT );
        httpServer = new HttpServerInstance( "router-test", config, routesProvider );
