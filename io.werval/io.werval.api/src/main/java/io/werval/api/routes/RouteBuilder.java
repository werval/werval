 ...
 * import io.werval.api.routes.RoutesBuilder;
 *
 * import static io.werval.api.routes.RoutesBuilder.p;
 *
...
public interface RouteBuilder
{
    ...
    interface RouteParser
    {
         ...
         *
         * @throws io.werval.api.exceptions.IllegalRouteException when one of the textual route definitions is invalid
         */
         ...
         * @return Parsed Routes
         *
         * @throws io.werval.api.exceptions.IllegalRouteException when the textual route definition is invalid
         */
