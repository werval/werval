...
public class JSONPluginTest
{
    ...
    public static final WervalHttpRule WERVAL = new WervalHttpRule( new RoutesParserProvider(
        "GET /static io.werval.modules.json.JSONPluginTest$Controller.staticJson\n"
        + "GET /jsonp io.werval.modules.json.JSONPluginTest$Controller.jsonp( String callback ?= 'callback' )"
    ) );
