...
public class EhCacheMetricsTest
{
        ...
        throws Exception
    {
        expect()
            ...
            .body( "meters.'io.werval.modules.cache.ehcache.werval-cache.hits'.count", is( 2 ) )
            .body( "meters.'io.werval.modules.cache.ehcache.werval-cache.misses'.count", is( 4 ) )
            .body( "timers.'io.werval.modules.cache.ehcache.werval-cache.gets'.count", is( 6 ) )
            .body( "timers.'io.werval.modules.cache.ehcache.werval-cache.sets'.count", is( 2 ) )
            .body( "timers.'io.werval.modules.cache.ehcache.werval-cache.removes'.count", is( 1 ) )
            .when()
            .get( "/" );
    }
}
