    ...
    extends TemplatesTest
{
    ...
    public void namedTemplate()
    {
        ...
        assertThat( metrics.timer( "io.werval.modules.templates.thymeleaf.named" ).getCount(), is( 1L ) );
        assertThat( metrics.timer( name( "io.werval.modules.templates.thymeleaf.named", templateName() ) ).getCount(), is( 1L ) );
        assertThat( metrics.timer( "io.werval.modules.templates.thymeleaf.inline" ).getCount(), is( 0L ) );
    }
    ...
    public void stringTemplate()
    {
        ...
        MetricRegistry metrics = application().plugin( Metrics.class ).metrics();
        assertThat( metrics.timer( "io.werval.modules.templates.thymeleaf.named" ).getCount(), is( 0L ) );
        assertThat( metrics.timer( "io.werval.modules.templates.thymeleaf.inline" ).getCount(), is( 1L ) );
    }
}
