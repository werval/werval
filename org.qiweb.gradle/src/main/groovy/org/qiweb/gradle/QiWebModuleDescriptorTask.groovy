 ...
 */
class QiWebModuleDescriptorTask extends DefaultTask
{
    /**
     * Skip flag.
     */
    ...
    throws Exception
    {
        if( skip )
        {
            project.logger.info 'QiWeb module descriptor generation skipped'
            return;
        }
        ...
        if( changed )
        {
            def genDescBaseDir = project.file( "build/generated-src/qiweb-dyndesc/resources/META-INF" )
