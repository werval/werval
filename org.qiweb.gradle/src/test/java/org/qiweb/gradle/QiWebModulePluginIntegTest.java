    ...
    extends AbstractQiWebIntegTest
{
        ...
        throws IOException
    {
        ...
        assertTrue(
            new File(
                tmp.getRoot(),
                "build/generated-src/qiweb-dyndesc/resources/META-INF/qiweb-plugins.properties"
            ).exists()
        );
        ...
        assertTrue( new File( tmp.getRoot(), "build/generated-src/qiweb-dyndocs/resources/reference.conf" ).exists() );
