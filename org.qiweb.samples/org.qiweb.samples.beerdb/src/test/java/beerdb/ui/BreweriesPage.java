    ...
    extends FluentPage
{
    ...
    public BreweriesPage( WebDriver driver, QiWebTestSupport qiweb )
    {
        super( driver );
    ...
    {
        return qiweb.baseHttpUrl() + "/#/breweries";
    }

    @Override
    public void isAt()
    {
        assertThat( title() ).isEqualTo( "Beer Database - QiWeb Sample App" );
